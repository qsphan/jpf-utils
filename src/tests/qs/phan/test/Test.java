...
public class Test {
	boolean test() {
		...
		conf.setProperty("site", "${jpf-utils}../site.properties");
		conf.setProperty("classpath", "${jpf-utils}/build/tests;${jpf-bmc}/build/examples;");
		...
		conf.setProperty("listener", "qs.phan.test.TestPathListener");
